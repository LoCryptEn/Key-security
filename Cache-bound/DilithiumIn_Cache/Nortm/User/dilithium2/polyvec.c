...
void polyvec_matrix_expand_test(polyvecl* mat[K], const uint8_t rho[SEEDBYTES]) {
  unsigned int i, j;
...
void polyvec_matrix_pointwise_montgomery_test(polyveck *t, const polyvecl* mat[K], const polyvecl *v) {
  unsigned int i;
