...
int SignMessage(const uint8 p_privateKey[ECC_BYTES], uint8 p_msg[MSG_LEN], uint8 p_signature[ECC_BYTES*2], int p_len){
    uint8 digest[256];
	//e = sha256(msg)
...
int SignMessageSafe(const uint8 p_privateKey[ECC_BYTES], uint8 p_msg[MSG_LEN], uint8 p_signature[ECC_BYTES*2], int p_len){
    uint8 digest[256];
	//e = sha256(msg)
